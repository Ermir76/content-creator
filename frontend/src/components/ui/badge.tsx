  ...
  "inline-flex items-center rounded-full border-2 px-3 py-1 text-xs font-bold transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        highlight:
          "border-transparent bg-highlight text-highlight-foreground hover:bg-highlight/80 hover:scale-105",
        accent:
          "border-transparent bg-accent text-accent-foreground hover:bg-accent/80 hover:scale-105",
      },
    },
    defaultVariants: {
      variant: "default",
